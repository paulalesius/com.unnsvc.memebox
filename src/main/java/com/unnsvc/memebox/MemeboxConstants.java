...
public class MemeboxConstants {
	...
	public static final String NAME_DATA_IMAGE_DIRECTORY = "images";
	public static final String NAME_DATA_THUMBNAIL_DIRECTORY = "thumbnails";

	/**
	 * META_ are metadata properties
	 */
